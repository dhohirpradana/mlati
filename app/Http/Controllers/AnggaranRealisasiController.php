...
class AnggaranRealisasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->jenis == "pendapatan") {
            $anggaran_realisasi = AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($data) {
    ...
    public function laporan_apbdes(Request $request)
    {
        ...
        if ($request->jenis == "laporan") {
            return view('anggaran-realisasi.laporan-apbdes', compact('kelurahan', 'detail_jenis_anggaran', 'data'));
        } elseif ($request->jenis == "grafik") {
            return view('anggaran-realisasi.grafik-apbdes-umum', compact('kelurahan', 'detail_jenis_anggaran', 'data'));
        } else {
            return redirect('laporan-apbdes?jenis=laporan&tahun=' . date('Y'));
        }
    }
    ...
    public function laporan($request)
    {
        ...
        foreach (AnggaranRealisasi::whereTahun($request->tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
    ...
    public function cart(Request $request)
    {
        ...
        foreach (AnggaranRealisasi::whereTahun($tahun)->whereHas('detail_jenis_anggaran', function ($jenis) {
            $jenis->where('jenis_anggaran_id', 4);
        })->get() as $item) {
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/anggaran-realisasi?jenis=' . $jenis . "&tahun=" . $request->tahun)->with('success', 'Anggaran Realisasi APBD berhasil ditambahkan');
    }
    ...
    public function update(Request $request, AnggaranRealisasi $anggaran_realisasi)
    {
        ...
        return redirect()->route('anggaran-realisasi.index')->with('success', 'Anggaran Realisasi APBD berhasil diperbarui');
    }
