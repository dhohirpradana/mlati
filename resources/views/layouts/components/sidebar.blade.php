<div class="container-fluid">
    ...
    <a class="text-center pt-0" href="{{ route('home.index') }}">
        <h1 class="text-primary font-weight-900 text-uppercase">Kelurahan {{ $kelurahan->nama_kelurahan }}</h1>
    </a>
    <!-- User -->
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="row">
                <div class="col-6 collapse-brand">
                    <a href="{{ route('home.index') }}">
                        <h1 class="text-primary"><b>Kelurahan {{ $kelurahan->nama_kelurahan }}</b></h1>
                    </a>
                </div>
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='penduduk' ||
                    Request::segment(1)=='tambah-penduduk' ) active @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='anggaran-realisasi' ||
                    Request::segment(1)=='tambah-anggaran-realisasi' ) active @endif"
                    href="{{ url('anggaran-realisasi?jenis=pendapatan&tahun=' . date('Y')) }}">
                    <i class="fas fa-coins text-success"></i>
                    <span class="nav-link-inner--text">Kelola APBD</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='surat' ||
                    Request::segment(1)=='tambah-surat' ) active @endif"
            ...
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='kelola-pemerintahan-kelurahan' ||
                    Request::segment(1)=='tambah-pemerintahan-kelurahan' ||
                    Request::segment(1)=='pemerintahan-kelurahan' ) active @endif"
                    href="{{ route('pemerintahan-kelurahan.index') }}">
                    <i class="fas fa-atlas text-success"></i>
                    <span class="nav-link-inner--text">Kelola Informasi Kelurahan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='kelola-berita' ||
                    Request::segment(1)=='tambah-berita' || Request::segment(1)=='berita' ) active @endif" href="{{ route('berita.index') }}">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='profil-kelurahan' ) active @endif" href="{{ route('profil-kelurahan') }}">
                    <i class="fas fa-users text-info"></i>
                    <span class="nav-link-inner--text">Profil Kelurahan</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if (Request::segment(1)=='profil' ||
                    Request::segment(1)=='pengaturan' ) active @endif"
                    href="{{ route('profil') }}">
