...
@section('title', 'Kelurahan ' . $kelurahan->nama_kelurahan . ' - Berita ' . $berita->judul)

@section('styles')
    <meta name="description"
        content="Berita {{ $berita->judul }} Kelurahan {{ $kelurahan->nama_kelurahan }}, Kecamatan {{ $kelurahan->nama_kecamatan }}, Kabupaten {{ $kelurahan->nama_kabupaten }}.">
    ...
    @if ($berita->gambar)
        <div class="row mb-5">
            <div class="col-md text-center">
                <img class="mw-100" src="{{ url(Storage::url($berita->gambar)) }}"
