...
@section('title', 'Website Resmi Pemerintah Kelurahan ' . $kelurahan->nama_kelurahan . ' - Berita')

@section('styles')
    <meta name="description"
        content="Macam-macam berita Kelurahan {{ $kelurahan->nama_kelurahan }}, Kecamatan {{ $kelurahan->nama_kecamatan }}, Kabupaten {{ $kelurahan->nama_kabupaten }}.">
...
@section('header')
    ...
    <p class="text-white">Berita Kelurahan {{ $kelurahan->nama_kelurahan }}, masyarakat dapat dengan mudah mengetahui
        informasi
        seputar
        berita kelurahan {{ $kelurahan->nama_kelurahan }}.</p>
@endsection
