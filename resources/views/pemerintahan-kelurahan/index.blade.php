                        ...
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    ...
                                    <p class="mb-0 text-sm">Kelola Informasi Kelurahan</p>
                                </div>
                                <div class="mb-3">
                                    <a href="{{ route('pemerintahan-kelurahan.create') }}" class="btn btn-success"
                                        title="Tambah"><i class="fas fa-plus"></i> Tambah Informasi Kelurahan</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('content')
    ...
    <div class="row mt-4 justify-content-center">
        @forelse ($pemerintahan_kelurahan as $item)
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card animate-up shadow">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('pemerintahan-kelurahan.edit', $item) }}" class="btn btn-sm btn-success"
                                title="Edit"><i class="fas fa-edit"></i> Edit</a>
                            <a class="btn btn-sm btn-danger hapus-data" data-nama="{{ $item->judul }}"
                                data-action="{{ route('pemerintahan-kelurahan.destroy', $item) }}" data-toggle="modal"
        ...
        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
            <div class="modal-content bg-gradient-danger">
                ...
                <div class="modal-header">
                    <h6 class="modal-title" id="modal-title-delete">Hapus Informasi Kelurahan?</h6>
                ...
                <div class="modal-body">
                    ...
                    <div class="py-3 text-center">
                        ...
                        <p>Menghapus informasi pemerintahan kelurahan akan menghapus semua data yang dimilikinya</p>
