...
@section('title', 'Tambah Informasi Kelurahan')
                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <h2 class="mb-0">Tambah Informasi Kelurahan</h2>
                                    <p class="mb-0 text-sm">Kelola Informasi Kelurahan</p>
                                </div>
                                <div class="mb-3">
                                    <a href="{{ route('pemerintahan-kelurahan.index') }}" class="btn btn-success"
                                        title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col">
            <div class="card bg-secondary shadow h-100">
                <div class="card-header bg-white border-0">
                    <h3 class="mb-0">Tambah Informasi Kelurahan</h3>
                </div>
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('pemerintahan-kelurahan.store') }}" method="post"
