...
@section('title', 'Website Resmi Kelurahan ' . $kelurahan->nama_kelurahan . ' - Kelurahan')

@section('styles')
    <meta name="description"
        content="Macam-macam sejarah Kelurahan {{ $kelurahan->nama_kelurahan }}, Kecamatan {{ $kelurahan->nama_kecamatan }}, Kabupaten {{ $kelurahan->nama_kabupaten }}.">
...
@section('header')
    ...
    <p class="text-white">Kelurahan {{ $kelurahan->nama_kelurahan }}, masyarakat dapat dengan mudah mengetahui informasi
        seputar
        kelurahan {{ $kelurahan->nama_kelurahan }}.</p>
@endsection
