                            ...
                            <div
                                ...
                                <div class="mb-3">
                                    <a href="{{ route('anggaran-realisasi.create') }}?jenis={{ request('jenis') }}&tahun={{ request('tahun') }}&page={{ request('page') }}"
                                        class="btn btn-success" title="Tambah"><i class="fas fa-plus"></i> Tambah APBD</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger hapus-data"
                                        ...
                                        data-action="{{ route('anggaran-realisasi.destroy', $item) }}"
                                        data-toggle="modal" href="#modal-hapus"><i data-toggle="tooltip" title="Hapus"
                                            class="fas fa-trash"></i></a>
                                </td>
                                <td>{{ $item->detail_jenis_anggaran->nama ? $item->detail_jenis_anggaran->nama : $item->detail_jenis_anggaran->kelompok_jenis_anggaran->nama }}
                                    {{ $item->keterangan_lainnya ? '(' . $item->keterangan_lainnya . ')' : '' }}</td>
