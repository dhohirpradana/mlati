...
@section('title',
    'Website Resmi Pemerintah Kelurahan ' .
    App\Kelurahan::find(1)->nama_kelurahan .
    ' - Statistik
    Penduduk',)
...
@section('header')
    <h1 class="text-white text-muted">LAPORAN APBD</h1>
    <p class="text-white">Laporan Anggaran Pendapatan Belanja Kelurahan {{ $kelurahan->nama_kelurahan }}, masyarakat dapat
        dengan mudah
        mengetahui informasi mengenai Laporan Anggaran Pendapatan Belanja Kelurahan {{ $kelurahan->nama_kelurahan }}.</p>
@endsection
