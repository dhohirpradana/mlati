...
@section('title', 'Website Resmi Pemerintah Kelurahan ' . App\Kelurahan::find(1)->nama_kelurahan . ' - Statistik
    Penduduk')
...
@section('header')
    <h1 class="text-white text-muted">GRAFIK APBD Kelurahan</h1>
    <p class="text-white">Grafik Anggaran Pendapatan Belanja Kelurahan {{ $kelurahan->nama_kelurahan }}, masyarakat dapat
        dengan
        mudah mengetahui informasi mengenai Grafik Anggaran Pendapatan Belanja Kelurahan {{ $kelurahan->nama_kelurahan }}.
    </p>
@endsection
                        ...
                        <li class="nav-item m-1">
                            <a class="nav-link tab {{ request('jenis') == 'laporan' ? 'active' : '' }}"
                                href="{{ URL::current() }}?jenis=laporan&tahun={{ request('tahun') }}"><i
                                    class="fas fa-hand-holding-usd mr-2"></i>Laporan</a>
                        </li>
                        <li class="nav-item m-1">
