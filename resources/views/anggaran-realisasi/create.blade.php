...
@section('title', 'Tambah Anggaran Pendapatan Belanja Kelurahan')
                    ...
                    <div class="card shadow h-100">
                        <div class="card-header border-0">
                            <div
                                ...
                                <div class="mb-3">
                                    <h2 class="mb-0">Tambah Anggaran Pendapatan Belanja Kelurahan</h2>
        ...
        <div class="col">
            <div class="card bg-secondary shadow h-100">
                <div class="card-header bg-white border-0">
                    <h3 class="mb-0">Tambah Anggaran Pendapatan Belanja Kelurahan</h3>
                </div>
                <div class="card-body">
                    <form autocomplete="off" action="{{ route('anggaran-realisasi.store') }}" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="number" onkeypress="return hanyaAngka(event);"
                                    ...
                                    value="{{ old('tahun', request('tahun') ? request('tahun') : date('Y')) }}">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <select class="form-control @error('detail_jenis_anggaran_id') is-invalid @enderror"
                                    ...
                                    value="{{ old('detail_jenis_anggaran_id') }}">
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control @error('keterangan_lainnya') is-invalid @enderror"
                                    ...
                                    placeholder="Masukkan Keterangan Lainnya ...">{{ old('keterangan_lainnya') }}</textarea>
            ...
            if ($("#jenis_anggaran") != "") {
                $.getJSON(baseURL + "/detail-jenis-anggaran/" + $("#jenis_anggaran").val(), function(response) {
                    ...
                    $.each(response, function(key, item) {
                        ...
                        $("#detail_jenis_anggaran_id").val($("#detail_jenis_anggaran_id").attr(
                            'value'));
                    });
                });
            }
