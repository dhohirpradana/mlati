                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" class="form-control @error('kk') is-invalid @enderror" name="kk"
                                    placeholder="Masukkan KK ..." value="{{ old('kk', $penduduk->kk) }}">
                                @error('kk')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                                    placeholder="Masukkan Nama ..." value="{{ old('nama', $penduduk->nama) }}">
                                @error('nama')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('jenis_kelamin') is-invalid @enderror"
                                    ...
                                    <option value="1"
                                        {{ old('jenis_kelamin', $penduduk->jenis_kelamin) == 1 ? 'selected' : '' }}>
                                        Laki-laki</option>
                                    <option value="2"
                                        {{ old('jenis_kelamin', $penduduk->jenis_kelamin) == 2 ? 'selected' : '' }}>
                                        Perempuan</option>
                                </select>
                                ...
                                <select class="form-control @error('darah_id') is-invalid @enderror" name="darah_id"
                                    ...
                                    @foreach ($darah as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('darah_id', $penduduk->darah_id) == $item->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('agama_id') is-invalid @enderror" name="agama_id"
                                    ...
                                    @foreach ($agama as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('agama_id', $penduduk->agama_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('agama_id')<span
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('pendidikan_id') is-invalid @enderror"
                                    ...
                                    @foreach ($pendidikan as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('pendidikan_id', $penduduk->pendidikan_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('pendidikan_id')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('pekerjaan_id') is-invalid @enderror" name="pekerjaan_id"
                                    ...
                                    @foreach ($pekerjaan as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('pekerjaan_id', $penduduk->pekerjaan_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('pekerjaan_id')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('status_perkawinan_id') is-invalid @enderror"
                                    ...
                                    @foreach ($status_perkawinan as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('status_perkawinan_id', $penduduk->status_perkawinan_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('status_perkawinan_id')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select
                                    ...
                                    @foreach ($status_hubungan_dalam_keluarga as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('status_hubungan_dalam_keluarga_id', $penduduk->status_hubungan_dalam_keluarga_id) == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}</option>
                                    @endforeach
                                </select>
                                @error('status_hubungan_dalam_keluarga_id')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                <select class="form-control @error('kewarganegaraan') is-invalid @enderror"
                                    ...
                                    <option value="1"
                                        {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 1 ? 'selected' : '' }}>
                                        WNI</option>
                                    <option value="2"
                                        {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 2 ? 'selected' : '' }}>
                                        WNA</option>
                                    <option value="3"
                                        {{ old('kewarganegaraan', $penduduk->kewarganegaraan) == 3 ? 'selected' : '' }}>
                                        Dua Kewarganegaraan</option>
                                </select>
                                @error('kewarganegaraan')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-lg-4 col-md-6">
                            ...
                            <div class="form-group col-lg-4 col-md-6">
                                ...
                                @error('nomor_kitas_atau_kitap')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('nik_ayah') is-invalid @enderror"
                                    name="nik_ayah" placeholder="Masukkan NIK Ayah ..."
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control @error('nik_ibu') is-invalid @enderror"
                                    name="nik_ibu" placeholder="Masukkan NIK Ibu ..."
                            ...
                            <div class="form-group col-12">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat"
                                    id="alamat"
                                    placeholder="Masukkan Alamat ...">{{ old('alamat', $penduduk->alamat) }}</textarea>
                                @error('alamat')<span
                                    class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                            </div>
                        </div>
