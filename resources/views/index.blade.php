...
@section('title', 'Website Resmi Kelurahan' . $kelurahan->nama_kelurahan . ' - Beranda')

@section('styles')
    <meta name="description"
        content="Website Resmi Kelurahan {{ $kelurahan->nama_kelurahan }}, Kecamatan {{ $kelurahan->nama_kecamatan }}, Kabupaten {{ $kelurahan->nama_kabupaten }}. Melayani pembuatan surat keterangan secara online">
...
@section('header')
    ...
    <h2 class="text-lead text-white">
        <b><strong>KELURAHAN {{ Str::upper($kelurahan->nama_kelurahan) }} <br> KECAMATAN
                {{ Str::upper($kelurahan->nama_kecamatan) }} <br />KABUPATEN
                {{ Str::upper($kelurahan->nama_kabupaten) }}</strong></b>
    </h2>
@endsection
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-6 border-bottom">
                                ...
                                <p class="text-white">Dengan menggunakan layanan surat website Kelurahan
                                    {{ $kelurahan->nama_kelurahan }}, masyarakat dapat dengan mudah membuat beberapa
                                    surat
    ...
    <div class="card shadow h-100 mb-5" style="margin-top:100px">
        <div class="card-header">
            <div
                ...
                <div class="mb-1">
                    <h2 class="mb-0">Grafik Pelaksanaan APBD</h2>
                </div>
                <div class="mb-1">
                    ...
                    <div class="header-body text-center mt-5 mb-3">
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-6 border-bottom">
                                ...
                                <p class="text-white">Berita seputar kelurahan {{ $kelurahan->nama_kelurahan }}.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-body text-center mt-5 mb-3">
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-6 border-bottom">
                                ...
                                <p class="text-white">Pemerintahan kelurahan {{ $kelurahan->nama_kelurahan }}, masyarakat
                                    dapat
                                    dengan
                                    mudah mengetahui informasi seputar kelurahan {{ $kelurahan->nama_kelurahan }}.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="header-body text-center mt-5 mb-3">
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-6 border-bottom">
                                ...
                                <p class="text-white">Gallery Kelurahan {{ $kelurahan->nama_kelurahan }}, masyarakat
                                    dapat
                                    dengan
                                    mudah
                                    mengetahui gallery kelurahan {{ $kelurahan->nama_kelurahan }}.</p>
                            </div>
                        </div>
                    </div>
                </div>
